...
Gas Town is built on five core patterns that enable scaling to 20-30+ agents:

1. **[Hook System](docs/hooks.md)** - Durable work attachment (survives crashes)
2. **[Propulsion Principle](docs/propulsion-principle.md)** - Self-activating workers
3. **[Convoy System](docs/convoy.md)** - Batch work tracking across rigs
4. **[ZFC Pattern](docs/zfc-pattern.md)** - Zero Friction Control (distributed state)
5. **[Molecules](docs/molecules.md)** - Resumable workflows

**For Claude agents:** See [CLAUDE.md](CLAUDE.md) for architectural overview and agent guide.

**For developers:** See [docs/](docs/) for full documentation.
