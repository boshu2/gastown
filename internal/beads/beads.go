...
func (b *Beads) run(args ...string) ([]byte, error) {
	...
	// Note: --no-daemon was removed in bd v0.56+ (daemon mode no longer exists).
	...
	// Handle bd edge case: when issue not found, bd may exit 0 but write
	// error to stderr with empty stdout. Detect and treat as error.
